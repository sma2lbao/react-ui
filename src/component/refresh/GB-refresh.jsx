...
export default class GB_refresh extends Component {
  ...
  render() {
    return(
      <div className={cx(styles.whiteBg)} style={{width: (this.props.radius + 1) + 'px', height: (this.props.radius + 1) + 'px', backgroundColor: this.props.bgColor}}>
        <div
          className={
